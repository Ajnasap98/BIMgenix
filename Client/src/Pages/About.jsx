      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
            BIMgenix is a technology-driven company specializing in Building Information
        ...
        <section className="mt-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              ...
              BIMgenix empowers clients to make informed decisions at every stage of the
              project lifecycle.
            </p>
          </div>
        </section>
